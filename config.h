...
static const char *fonts[]               = { "Fantasque Sans Mono:size=14", "JoyPixels:pixelsize=14:antialias=true:autohint=true" };
static const char dmenufont[]       	= "Fantasque Sans Mono:size=14";
static const 		  char col_gray1[]       			= "#282a2e"; //top bar background
static const 		  char col_gray2[]       			= "#282a2e"; //inactive window color
...
static const char *altbarcmd   = "/home/karsten/start.sh";

static const unsigned int baralpha        = 0xff;
static const unsigned int borderalpha     = 0x00;
static const char* SESSION_FILE = "/home/karsten/suckless/dwm/saves";
...
//static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray4, "-sf", col_gray4, "-sb", col_red, NULL };
